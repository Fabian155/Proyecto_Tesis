...
// ========================================
$qRedes = "SELECT red_nom, red_url, red_ico, red_dim
                ...
                <?php while ($red = pg_fetch_assoc($rRedes)): ?>
                  <a href="<?= htmlspecialchars($red['red_url']) ?>" target="_blank" rel="noopener"
                    ...
                    <img
                      src="<?=
                        htmlspecialchars(
                          preg_match('#^https?://#i', $red['red_ico'])
                            ? $red['red_ico']
                            : $baseURL . ltrim($red['red_ico'], '/')
                        )
                      ?>"
                      alt="<?= htmlspecialchars($red['red_nom']) ?>"
                      style="width:<?= htmlspecialchars($red['red_dim'] ?: '18px') ?>;height:auto;">
                  </a>
                <?php endwhile; ?>
              </div>
            <?php endif; ?>
